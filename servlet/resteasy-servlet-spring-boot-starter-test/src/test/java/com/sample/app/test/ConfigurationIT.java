...
/**
 * Integration test that tests a couple sample application (see resteasy-servlet-spring-boot-sample-app
 * and resteasy-servlet-spring-boot-sample-app-no-jaxrs).
